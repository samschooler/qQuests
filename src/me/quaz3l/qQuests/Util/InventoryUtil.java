...
public class InventoryUtil {
	 ...
	 * @return Does the inventory contain stock of this type?
	 */
	public static boolean hasItem(ItemStack item, Inventory inventory) {
	...
	public static void drop(ItemStack item, PlayerInventory inv) {
		Chat.logger("debug", item.getAmount()+"");
		inv.getHolder().getLocation().getWorld().dropItemNaturally(inv.getHolder().getLocation(), item);		
	}
}